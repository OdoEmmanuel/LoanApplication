                ...
                <form class="form">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-control-solid" placeholder="Enter New Password">
                        </div>
                        <div class="form-group">
                            <label>Repeat New Password *</label>
                            <input type="password" class="form-control form-control-solid" placeholder="Repeat New Password">
                        </div>
                        <!--begin: Code-->
