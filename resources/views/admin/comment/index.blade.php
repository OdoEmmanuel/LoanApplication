    ...
    <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Comments</h5>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center">
                ...
                <!--end::Button-->
                <!--begin::Button-->
                <a href="{{  url('create_comment') }}"
                    class="btn btn-light-success font-weight-bold btn-sm px-4 font-size-base ml-2">Add Comment</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Comment List
                            ...
                            <tbody class="datatable-body" style="">
                                <tr data-row="0" class="datatable-row" style="left: 0px;">
                                    ...
                                    <td data-field="Country" aria-label="Czech Republic" class="datatable-cell"><span
                                            style="width: 158px;">
                                            <div class="font-weight-bolder font-size-lg mb-0">Business</div>
                                        </span></td>
                                    <td data-field="ShipDate" aria-label="11/25/2016" class="datatable-cell"><span
                                            style="width: 158px;">
                                            <div class="font-weight-bolder text-primary mb-0">Trevor Admin Stanbridge</div>
                                        </span></td>
                                    <td data-field="CompanyName" aria-label="Gleason-Beahan" class="datatable-cell">
                                        <span style="width: 158px;">
                                            <div class="font-weight-bold text-muted">He is due for the loan</div>
                                        </span></td>
                                    <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                    class="datatable-cell"><span
                                        style="overflow: visible; position: relative; width: 130px;">
                                            <a href="{{ url('view_comment') }}"
                                            class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2"
                                            title="View Comment"> <span class="svg-icon svg-icon-md"><img src="assets/media/svg/icons/Home/Door-open.svg"/>
                                            </span> </a>
                                                <a href="{{ url('edit_comment') }}"
                                            class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2"
                                            title="Edit Comment"> <span class="svg-icon svg-icon-md"><img src="assets/media/svg/icons/Design/Edit.svg"/></span> </a>

                                                <a href="javascript:;"
                                            class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon"
                                            title="Delete Comment"> <span class="svg-icon svg-icon-md"><img src="assets/media/svg/icons/General/Trash.svg"/></span> </a>
                                    </span></td>
                                </tr>
