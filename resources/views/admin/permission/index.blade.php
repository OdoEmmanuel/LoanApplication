    ...
    <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Permission</h5>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="{{ url('create_permission') }}"
                    class="btn btn-light-success font-weight-bold btn-sm px-4 font-size-base ml-2">Add Permission</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Permission List
                            ...
                            <thead class="datatable-head">
                                <tr class="datatable-row" style="left: 0px;">
                                    ...
                                    <th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span
                                            style="width: 250px;">Title</span></th>
                            ...
                            <tbody class="datatable-body" style="">
                                ...
                                <td data-field="OrderID" aria-label="50051-0022" class="datatable-cell"><span
                                    ...
                                    <td data-field="OrderID" aria-label="50051-0022" class="datatable-cell"><span
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div class="ml-4">
                                                    <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">profile_password_edit</div>
                                                </div>
                                            </div>
                                        </span></td>
                                    <td data-field="Actions" data-autohide-disabled="false" aria-label="null"
                                        class="datatable-cell"><span
                                            style="overflow: visible; position: relative; width: 130px;">
                                                <a href="{{ url('view_permission') }}"
                                                class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2"
                                                title="View Status"> <span class="svg-icon svg-icon-md"><img src="assets/media/svg/icons/Home/Door-open.svg"/>
                                                </span> </a>
                                                    <a href="{{ url('edit_permission') }}"
                                                class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2"
                                                title="Edit Status"> <span class="svg-icon svg-icon-md"><img src="assets/media/svg/icons/Design/Edit.svg"/></span> </a>
