    ...
    <div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
        <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Status</h5>
                <!--end::Title-->
                <!--begin::Separator-->
            ...
            <div class="d-flex align-items-center">
                ...
                <a href="{{ url('create_status') }}"
                    class="btn btn-light-success font-weight-bold btn-sm px-4 font-size-base ml-2">Add Status</a>
                <!--end::Button-->
                <!--begin::Dropdown-->
            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Status List
                            ...
                            <thead class="datatable-head">
                                <tr class="datatable-row" style="left: 0px;">
                                    ...
                                    <th data-field="OrderID" class="datatable-cell datatable-cell-sort"><span
                                            style="width: 250px;">Name</span></th>
                            ...
                            <tbody class="datatable-body" style="">
                                <tr data-row="0" class="datatable-row" style="left: 0px;">
                                    ...
                                    <td class="datatable-cell-left datatable-cell"
                                        aria-label=""><span style="width: 40px;"><span
                                                class="font-weight-bolder">1</span></span></td>
                                    <td data-field="OrderID" aria-label="50051-0022" class="datatable-cell"><span
                                            style="width: 250px;">
                                            <div class="d-flex align-items-center">
                                                <div class="ml-4">
                                                    <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">Analyst processing</div>
                                                </div>
                                            </div>
                                        </span></td>
